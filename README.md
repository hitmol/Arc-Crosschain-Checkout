...
This is testnet software, is not audited, and does not provide automatic crosschain refunds. Refunds are paid to the invoice's Arc refund address. Merchant wallet-signature authentication, production-grade RPC redundancy, external monitoring, and a professional contract audit remain required. Read [SECURITY.md](SECURITY.md) and [known limitations](docs/KNOWN_LIMITATIONS.md).
