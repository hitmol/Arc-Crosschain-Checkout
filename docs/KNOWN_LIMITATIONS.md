...
- Authenticated indexed dashboard and verified JSON receipt APIs are implemented; the current web dashboard and receipt pages still use explicitly labeled placeholder layouts until the frontend phase consumes those APIs.
